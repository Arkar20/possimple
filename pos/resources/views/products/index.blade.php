                        ...
                        <div class="product-carousel">
                            @forelse ($items as $item)
                                ...
                                <div class="product-f-image">
                                    <img src="{{asset('storage/items/img/'.$item->image)}}" alt="" height="300px">
                                    <div class="product-hover">
                                        <a href="{{route('addtocart',$item->id)}}" class="add-to-cart-link"><i class="fa fa-shopping-cart"></i> Add to cart</a>
                                    </div>
