                  ...
                  <form action="{{route('brand.update',[$brand->id])}}" method="POST">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="exampleInputEmail1" name="brand" aria-describedby="emailHelp"
                        placeholder="Enter brand" value="{{$brand->brand}}">
                      @error('brand')
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="company" value="{{$brand->company}}" id="exampleInputPassword1" placeholder="company">
                     @error('company')
                          <small class="text-danger">{{$message}}</small> 
                      @enderror
                    </div>
